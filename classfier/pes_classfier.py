...
def pes_classifer(filepath):
    ...
    gcn_model.load_state_dict(torch.load('models/para/gcn_model_all_pes.pth'))
    ...
    rnn_model.load_state_dict(torch.load('models/para/rnn_model_all_pes.pth'))
    ...
    DCAN_model.load_state_dict(torch.load('models/para/dcan_model_all_pes.pth'))
