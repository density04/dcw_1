...
def fun_classifer(filepath):
    ...
    gcn_model.load_state_dict(torch.load('models/para/gcn_model_all_fun.pth'))
    ...
    rnn_model.load_state_dict(torch.load('models/para/rnn_model_all_fun.pth'))
    ...
    DCAN_model.load_state_dict(torch.load('models/para/dcan_model_all_fun.pth'))
