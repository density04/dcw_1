...
def fun_classifer(filepath):
    ...
    gcn_model.load_state_dict(torch.load('para/gcn_model_all_fun.pth'))
    ...
    rnn_model.load_state_dict(torch.load('para/rnn_model_all_fun.pth'))
    ...
    DCAN_model.load_state_dict(torch.load('para/DCAN_model_all_fun.pth'))
